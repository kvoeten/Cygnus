...
public class IGCipher {
    ...
    /**
     * @param uSeqSnd  The ClientSocket's current sequence
     * @param aSrc     The input data (packet)
     * @param bDecrypt Whether to encrypt or decrypt the data
     * @author PacketBakery
     */
    public static void EncInit(int uSeqSnd, byte[] aSrc, boolean bDecrypt) {
